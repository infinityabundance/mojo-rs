...
use mojo_rs_interop::ipcz::messages::{
    self, DecodedMessage, MSG_ID_ACCEPT_BYPASS_LINK, MSG_ID_ACCEPT_INTRODUCTION,
    MSG_ID_ACCEPT_PARCEL, MSG_ID_ACCEPT_PARCEL_DRIVER_OBJECTS, MSG_ID_ADD_BLOCK_BUFFER,
    MSG_ID_BYPASS_PEER, MSG_ID_BYPASS_PEER_WITH_LINK, MSG_ID_CONNECT_FROM_BROKER_TO_BROKER,
    MSG_ID_CONNECT_FROM_BROKER_TO_NON_BROKER, MSG_ID_CONNECT_FROM_NON_BROKER_TO_BROKER,
    MSG_ID_CONNECT_TO_REFERRED_BROKER, MSG_ID_CONNECT_TO_REFERRED_NON_BROKER, MSG_ID_FLUSH_ROUTER,
    MSG_ID_NON_BROKER_REFERRAL_ACCEPTED, MSG_ID_NON_BROKER_REFERRAL_REJECTED,
    MSG_ID_PROVIDE_MEMORY, MSG_ID_PROXY_WILL_STOP, MSG_ID_REFER_NON_BROKER,
    MSG_ID_REJECT_INTRODUCTION, MSG_ID_REQUEST_INDIRECT_INTRODUCTION, MSG_ID_REQUEST_INTRODUCTION,
    MSG_ID_REQUEST_MEMORY, MSG_ID_ROUTE_CLOSED, MSG_ID_ROUTE_DISCONNECTED, MSG_ID_STOP_PROXYING,
...
fn main() -> ExitCode {
    ...
    for (i, m) in msgs.iter().enumerate() {
        ...
        let name = match id {
            ...
            MSG_ID_REFER_NON_BROKER => "ReferNonBroker",
            MSG_ID_CONNECT_TO_REFERRED_BROKER => "ConnectToReferredBroker",
            MSG_ID_CONNECT_TO_REFERRED_NON_BROKER => "ConnectToReferredNonBroker",
            MSG_ID_NON_BROKER_REFERRAL_ACCEPTED => "NonBrokerReferralAccepted",
            MSG_ID_NON_BROKER_REFERRAL_REJECTED => "NonBrokerReferralRejected",
            MSG_ID_CONNECT_FROM_BROKER_TO_BROKER => "ConnectFromBrokerToBroker",
            MSG_ID_REQUEST_INTRODUCTION => "RequestIntroduction",
            MSG_ID_ACCEPT_INTRODUCTION => "AcceptIntroduction",
            MSG_ID_REJECT_INTRODUCTION => "RejectIntroduction",
            MSG_ID_REQUEST_INDIRECT_INTRODUCTION => "RequestIndirectIntroduction",
